...
class HybridsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hybrid" do
    assert_difference('Hybrid.count') do
      post hybrids_url, params: { hybrid: { biography: @hybrid.biography, image: @hybrid.image, name: @hybrid.name, personality: @hybrid.personality, species: @hybrid.species } }, as: :json
    end
  ...
  test "should update hybrid" do
    patch hybrid_url(@hybrid), params: { hybrid: { biography: @hybrid.biography, image: @hybrid.image, name: @hybrid.name, personality: @hybrid.personality, species: @hybrid.species } }, as: :json
    assert_response 200
  end
